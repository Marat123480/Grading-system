...
<div class="row">
    <div class="col-12">
        <form class="form-inline" method="POST" action="<?php echo e(action('StudentController@storeStudent', $group_id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\grade\resources\views/create-student.blade.php ENDPATH**/ ?>