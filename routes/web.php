...
Route::get('/groups/studentai/{group}', 'StudentController@getStudent')->name('student');
Route::post('/groups/studentai/{id}', 'StudentController@storeStudent')->name('storeStudent');
Route::get('/groups/studentai/student/{student}', 'StudentController@getUpdateStudent')->name('update-student');
Route::put('/groups/studentai/student/{id}', 'StudentController@updateStudent')->name('updatePutStudent');
Route::delete('/groups/studentai/student/{id}', 'StudentController@destroyStudent')->name('deleteStudent');
...
Route::get('/groups', 'GroupController@getGroup')->name('group');
Route::post('/groups', 'GroupController@storeGroup')->name('storeGroup');
Route::get('/groups/{group}', 'GroupController@getUpdateGroup')->name('update-group');
Route::put('/groups/{id}', 'GroupController@updateGroup')->name('updatePutGroup');
Route::delete('/groups/{id}', 'GroupController@destroyGroup')->name('deleteGroup');
});
